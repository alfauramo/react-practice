...
describe('List', () => {
  ...
  it('renders two items', () => {
    ...
    const component = renderer.create(<List stories={list} />);
...
describe('SearchForm', () => {
  ...
  it('changes the input field', () => {
    ...
    expect(searchFormProps.onSearchInput).toHaveBeenCalledTimes(2);
  ...
  it('submits the form', () => {
    ...
    expect(searchFormProps.onSearchSubmit).toHaveBeenCalledTimes(2);
...
describe('App', () => {
  if ('secceeds fetching data with a list', () => {
    const list = [
      {
        title: 'React',
        url: 'https://reactjs.org/',
